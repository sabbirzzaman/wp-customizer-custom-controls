<?php
/**
 * textdomain Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Textdomain_Custom_Control extends WP_Customize_Control {
		protected function get_textdomain_resource_url() {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Custom_Section extends WP_Customize_Section {
		protected function get_textdomain_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Textdomain_Image_Checkbox_Custom_Control extends Textdomain_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Textdomain_Text_Radio_Button_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Image_Radio_Button_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Single_Accordion_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'textdomain-custom-controls-js', $this->get_textdomain_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Simple_Notice_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Slider_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'textdomain-custom-controls-js', $this->get_textdomain_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Toggle_Switch_Custom_control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Sortable_Repeater_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Dropdown_Select2_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'textdomain-select2-js', $this->get_textdomain_resource_url() . 'inc/assets/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'textdomain-custom-controls-js', $this->get_textdomain_resource_url() . 'inc/assets/js/customizer.js', array( 'textdomain-select2-js' ), '1.0', true );
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'textdomain-select2-css', $this->get_textdomain_resource_url() . 'inc/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Dropdown_Posts_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_TinyMCE_Custom_control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['textdomaintinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['textdomaintinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['textdomainmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Google_Font_Select_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->textdomain_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->textdomain_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['textdomainfontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'textdomain' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'textdomain' ) ?> <italic><?php esc_html_e( 'italic text', 'textdomain' ) ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'textdomain' ) ?> <strong><?php esc_html_e( 'bold text', 'textdomain' ) ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function textdomain_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function textdomain_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_textdomain_resource_url() . 'inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_textdomain_resource_url() . 'inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class Textdomain_Customize_Alpha_Color_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'textdomain-custom-controls-js', $this->get_textdomain_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Textdomain_Alpha_Color_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_textdomain_resource_url() . 'inc/assets/js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Textdomain_Pill_Checkbox_Custom_Control extends Textdomain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'textdomain-custom-controls-js', $this->get_textdomain_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'textdomain-custom-controls-css', $this->get_textdomain_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Textdomain_Upsell_Section extends Textdomain_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'textdomain-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="textdomain_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'textdomain_url_sanitization' ) ) {
		function textdomain_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'textdomain_switch_sanitization' ) ) {
		function textdomain_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'textdomain_radio_sanitization' ) ) {
		function textdomain_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'textdomain_sanitize_integer' ) ) {
		function textdomain_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'textdomain_text_sanitization' ) ) {
		function textdomain_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'textdomain_array_sanitization' ) ) {
		function textdomain_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'textdomain_hex_rgba_sanitization' ) ) {
		function textdomain_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgb' ) ) {
				...
				if ( false === strpos( $input, 'rgba' ) ) {
					...
					$input = 'rgb(' . textdomain_in_range( $red, 0, 255 ) . ',' . textdomain_in_range( $green, 0, 255 ) . ',' . textdomain_in_range( $blue, 0, 255 ) . ')';
				}
				else {
					// Sanitize as RGBa color
					$input = str_replace( ' ', '', $input );
					sscanf( $input, 'rgba(%d,%d,%d,%f)', $red, $green, $blue, $alpha );
					$input = 'rgba(' . textdomain_in_range( $red, 0, 255 ) . ',' . textdomain_in_range( $green, 0, 255 ) . ',' . textdomain_in_range( $blue, 0, 255 ) . ',' . textdomain_in_range( $alpha, 0, 1 ) . ')';
				}
			}
			return $input;
		}
	 ...
	 */
	if ( ! function_exists( 'textdomain_in_range' ) ) {
		function textdomain_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'textdomain_google_font_sanitization' ) ) {
		function textdomain_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'textdomain_date_time_sanitization' ) ) {
		function textdomain_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'textdomain_range_sanitization' ) ) {
		function textdomain_range_sanitization( $input, $setting ) {
			...
			return textdomain_in_range( $number, $min, $max );
		}
	}
